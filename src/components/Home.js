...
const Home = props => {
  ...
  return (
    <div className="home-page">
      ...
      <p>Share your mix with guests</p></div>
      <div className= "img2"><img src={headphone} alt="headphone" />
      <p>Send request &amp vote on what gets played next </p></div>
      <div className= "img3"><img src={group2} alt="group_pic" />
      <p>Save and share your favorite mixes </p></div>

...
### [Back end](https://github.com/Lambda-School-Labs/djhelper-be) built using: Node.JS, Express, Postgresql, AWS
...
5. If you want to use localhost for your back end, see the [back end documentation](https://github.com/Lambda-School-Labs/djhelper-be/blob/master/README.md) for instructions on setting that up.
